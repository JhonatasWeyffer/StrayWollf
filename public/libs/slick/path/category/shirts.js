...
function renderCamisas(products) {
  const container = document.querySelector('.camisas .produtos-grid');
  if (!container) return;
  ...
  adjustLayout(container, camisas.length);
}
